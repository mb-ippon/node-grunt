...
installer grunt : npm install grunt
installer grunt-contrib-clean : npm install grunt-contrib-clean --save-dev
installer grunt-contrib-concat : npm install grunt-contrib-concat --save-dev
installer grunt-contrib-uglify : npm install grunt-contrib-uglify --save-dev
installer grunt-contrib-cssmin : npm install grunt-contrib-cssmin --save-dev
installer grunt-processhtml : npm install grunt-processhtml --save-dev
...
en dev mode : grunt build_dev
en prod mode : grunt build_prod
